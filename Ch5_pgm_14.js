...
// Using showLine to display the player's name in a box
var showPlayerNameBox = function (playerName) {
    var length = playerName.length + 4; // 2 dashes on each side
    showLine(length);
    console.log("- " + playerName + " -");
    showLine(length);
};

// Example usage of showPlayerNameBox
showPlayerNameBox(player1.name);
showPlayerNameBox(player2.name);
